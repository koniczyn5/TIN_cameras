...
function cameralink_proto.dissector(buffer,pinfo,tree)
    ...
    local maxPackets = buffer(5,4):le_uint()
    local lastPackageSize = buffer(9,4):le_uint()
	subtree:add(buffer(0,1),"Number of packets: " .. maxPackets .. ". Size of last package: " .. lastPackageSize .. ". Filename: " .. buffer:raw(13,filenameSize))
